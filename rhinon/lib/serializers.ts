...
export function serializeCampaign(campaign: any): Campaign {
  return {
    ...
    audienceGroupName: campaign?.audienceGroupName ?? undefined,
    objective: campaign?.objective ?? undefined,
    notes: campaign?.notes ?? undefined,
    targetCompanies: Array.isArray(campaign?.targetCompanies) ? campaign.targetCompanies : [],
    sourceFilters: Array.isArray(campaign?.sourceFilters) ? campaign.sourceFilters : [],
    statusFilters: Array.isArray(campaign?.statusFilters) ? campaign.statusFilters : [],
    leadIds: Array.isArray(campaign?.leadIds) ? campaign.leadIds.map(toId) : [],
    autoEnrollMatchingLeads: Boolean(campaign?.autoEnrollMatchingLeads),
