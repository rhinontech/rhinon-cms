    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 lg:p-6">
      ...
      <div className={cn("w-full", stage === "signing" ? "max-w-none" : "max-w-lg")}>
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500">Rhinon Tech · Document Signing</p>
        </div>
        ...
        {stage === "invalid" && (
          <div className="bg-white rounded-2xl border border-gray-100 p-10 text-center">
            ...
            <p className="text-sm text-gray-500">This signing link has expired or already been used. Contact HR to resend it.</p>
          </div>
        )}
        ...
        {stage === "signing" && activeDoc && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="bg-zinc-900 px-6 py-5">
              <p className="text-white font-semibold text-lg">Welcome, {employeeName.split(" ")[0] || "there"}!</p>
              <p className="text-zinc-400 text-sm mt-0.5">Review and sign your documents to complete onboarding</p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="flex-1 min-w-0 p-6 flex flex-col gap-3">
                ...
                {activeDoc.viewUrl && (
                  <div className="h-[70vh] min-h-[420px] overflow-hidden rounded-lg border border-gray-200 bg-gray-100">
              ...
              <div className="lg:w-[420px] shrink-0 border-t lg:border-t-0 lg:border-l border-gray-100 p-6 flex flex-col gap-5">
                    ...
                    <div key={doc.id} className="flex items-center gap-2 flex-1">
                      <div
                        className={cn(
                          ...
                          doc.signed ? "bg-green-600 text-white" : i === activeIndex ? "bg-stone-900 text-white" : "bg-gray-100 text-gray-400"
                        )}
                      >
                        {doc.signed ? <TbCheck size={13} /> : i + 1}
                      </div>
                      <span className={cn("text-xs font-medium truncate", i === activeIndex ? "text-gray-900" : "text-gray-400")}>
                        {CATEGORY_LABEL[doc.category] ?? doc.title}
                      </span>
                      {i < documents.length - 1 && <div className="h-px flex-1 bg-gray-100" />}
                    </div>
                  ))}
                </div>
        ...
        {stage === "done" && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="px-6 py-5 space-y-3">
              ...
              <p className="text-sm text-gray-600 mb-2">Download your signed copies below for your records.</p>
              {documents.map((doc) => (
                <a
                  key={doc.id}
                ...
                >
                  ...
                  <TbDownload size={16} className="text-gray-400" />
                </a>
              ))}
            </div>
          </div>
