...
const Content = () => {
  ...
  return (
    <div className="flex gap-2 w-full h-full">
      <main className="flex flex-col gap-6 bg-card rounded-xl w-full">
      ...
      <aside
        className={`flex h-full flex-col bg-card rounded-l-xl transition-all duration-200 ease-in-out rounded-xl ${
