      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 overflow-auto">
        <div className="max-w-md w-full space-y-12">
          ...
          <div className="text-center space-y-1">
            <h1 className="text-2xl font-semibold text-foreground">Copilot is here to help.</h1>
            <p className="text-2xl font-semibold text-foreground">Just ask.</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-foreground/70">Copilot conversations are only visible to you.</p>
            </div>
          </div>

          {/* Copilot explained button */}
          <div className="flex justify-center">
            <Button variant="outline" className="rounded-full bg-card px-6 py-2 flex items-center gap-2">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative flex items-center">
            <input
              ...
              className="w-full py-3 px-4 pr-16 border border-border rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            />
            <div className="absolute right-3 flex items-center gap-2">
              <button className="text-muted-foreground hover:text-foreground/70">
                <svg
